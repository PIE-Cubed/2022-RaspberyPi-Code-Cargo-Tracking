...
set CLASSPATH=%APP_HOME%\lib\2199-RaspberyPi-Code-2022-Red-Cargo-all.jar

@rem Execute 2199-RaspberyPi-Code-2022-Red-Cargo
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %2199_RASPBERY_PI_CODE_2022_RED_CARGO_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
