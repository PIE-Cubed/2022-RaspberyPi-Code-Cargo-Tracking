...
set CLASSPATH=%APP_HOME%\lib\2022-RaspberyPi-Code-Cargo-Tracking-all.jar

@rem Execute 2022-RaspberyPi-Code-Cargo-Tracking
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %2022_RASPBERY_PI_CODE_CARGO_TRACKING_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
